  ...
  return (
    <Paper elevation={3} sx={{ padding: 2 }}>
      <Typography variant="h6">
        {intl.formatMessage({ id: 'userManagement.title' })}
      </Typography>
      <List>
        <ListItem>
          <ListItemText
            primary={`${ownerUser?.name} (${intl.formatMessage({
              id: 'userManagement.owner',
            })})`}
          />
        </ListItem>
        ...
        <>
          ...
          <Grid container spacing={1} alignItems="center">
            ...
            <Grid item xs>
              ...
              >
                <MenuItem value="">
                  {intl.formatMessage({ id: 'userManagement.selectUser' })}
                </MenuItem>
                {users
                  .filter(
                    (user) =>
            ...
            <Grid item>
              ...
              >
                {intl.formatMessage({ id: 'userManagement.addUser' })}
              </Button>
            </Grid>
          </Grid>
        </>
